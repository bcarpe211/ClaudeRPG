# Retired companion operations sequence/quartet tail

> **ARCHIVED — NON-AUTHORITATIVE — DO NOT EXECUTE.**

This is the retired pre-0.4.0 tail formerly embedded in companion operations.
It is historical evidence only; use the active [companion operations](../../../runtime-raiders/companion-operations.md)
and [employee beta](../../../runtime-raiders/employee-beta.md) procedures instead.

> **Historical pre-0.4.0 procedure.** The quartet, sequence, launcher, and
> canary system below is retired and must not be run. Use
> [`employee-beta.md`](../../../runtime-raiders/employee-beta.md) for the active one-app beta procedure.
