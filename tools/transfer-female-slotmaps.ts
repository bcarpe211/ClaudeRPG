...
export const FEMALE_OVERRIDES: Record<string, readonly PixelOverride[]> = {
  ...
  knight_F_a: [
    { x: 14, y: 1, slot: SLOTS.hair },
    { x: 15, y: 1, slot: SLOTS.hair },
    { x: 17, y: 1, slot: SLOTS.hair },
    { x: 18, y: 1, slot: SLOTS.hair },
    { x: 16, y: 2, slot: SLOTS.hair },
    { x: 17, y: 2, slot: SLOTS.hair },
    { x: 20, y: 2, slot: SLOTS.hair },
    { x: 17, y: 3, slot: SLOTS.hair },
    { x: 18, y: 3, slot: SLOTS.hair },
    { x: 19, y: 3, slot: SLOTS.hair },
    { x: 18, y: 4, slot: SLOTS.hair },
    { x: 19, y: 4, slot: SLOTS.hair },
    { x: 19, y: 5, slot: SLOTS.hair },
    { x: 20, y: 5, slot: SLOTS.hair },
    { x: 21, y: 5, slot: SLOTS.hair },
    { x: 19, y: 6, slot: SLOTS.hair },
    { x: 20, y: 6, slot: SLOTS.hair },
    { x: 20, y: 7, slot: SLOTS.hair },
    { x: 20, y: 8, slot: SLOTS.hair },
    { x: 19, y: 9, slot: SLOTS.hair },
    { x: 18, y: 10, slot: SLOTS.hair },
    { x: 7, y: 16, slot: SLOTS.outline },
    { x: 8, y: 17, slot: SLOTS.outline },
    { x: 7, y: 19, slot: SLOTS.cape },
    { x: 8, y: 19, slot: SLOTS.cape },
    { x: 9, y: 19, slot: SLOTS.cape },
    { x: 10, y: 19, slot: SLOTS.cape },
    { x: 11, y: 19, slot: SLOTS.cape },
  ],
  knight_F_b: [
    { x: 14, y: 2, slot: SLOTS.hair },
    { x: 15, y: 2, slot: SLOTS.hair },
    { x: 17, y: 2, slot: SLOTS.hair },
    { x: 18, y: 2, slot: SLOTS.hair },
    { x: 16, y: 3, slot: SLOTS.hair },
    { x: 17, y: 3, slot: SLOTS.hair },
    { x: 20, y: 3, slot: SLOTS.hair },
    { x: 17, y: 4, slot: SLOTS.hair },
    { x: 18, y: 4, slot: SLOTS.hair },
    { x: 19, y: 4, slot: SLOTS.hair },
    { x: 18, y: 5, slot: SLOTS.hair },
    { x: 19, y: 5, slot: SLOTS.hair },
    { x: 19, y: 6, slot: SLOTS.hair },
    { x: 20, y: 6, slot: SLOTS.hair },
    { x: 21, y: 6, slot: SLOTS.hair },
    { x: 19, y: 7, slot: SLOTS.hair },
    { x: 20, y: 7, slot: SLOTS.hair },
    { x: 20, y: 8, slot: SLOTS.hair },
    { x: 20, y: 9, slot: SLOTS.hair },
    { x: 19, y: 10, slot: SLOTS.hair },
    { x: 18, y: 11, slot: SLOTS.hair },
    { x: 7, y: 17, slot: SLOTS.outline },
    { x: 8, y: 18, slot: SLOTS.outline },
    { x: 7, y: 20, slot: SLOTS.cape },
    { x: 8, y: 20, slot: SLOTS.cape },
    { x: 9, y: 20, slot: SLOTS.cape },
    { x: 10, y: 20, slot: SLOTS.cape },
    { x: 11, y: 20, slot: SLOTS.cape },
  ],
  paladin_F_a: [
