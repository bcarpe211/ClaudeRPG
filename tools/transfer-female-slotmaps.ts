...
export const FEMALE_OVERRIDES: Record<string, readonly PixelOverride[]> = {
  ...
  berserker_F_b: [
    ...
    { x: 19, y: 11, slot: SLOTS.hair },
    { x: 17, y: 12, slot: SLOTS.hair },
    { x: 18, y: 12, slot: SLOTS.hair },
    { x: 9, y: 13, slot: SLOTS.facePaint },
    { x: 10, y: 13, slot: SLOTS.facePaint },
    { x: 14, y: 14, slot: SLOTS.body },
  ...
  priest_F_a: [
    ...
    { x: 10, y: 12, slot: SLOTS.facePaint },
    { x: 11, y: 12, slot: SLOTS.facePaint },
  ...
  priest_F_b: [
    ...
    { x: 10, y: 13, slot: SLOTS.facePaint },
    { x: 11, y: 13, slot: SLOTS.facePaint },
